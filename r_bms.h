...
/** Battery management system states */
typedef enum
{
    BMS_INIT_STATE = 0,
    BMS_NORMAL_STATE,
...
/** Battery management system state transition flags. */
typedef struct
{
    bool goto_normal;
    bool goto_sleep;
...
/* Function Name: bms_state_machine */
/******************************************************************************************************************//**
 * @brief This function processes the state machine.
 *********************************************************************************************************************/
void r_bms_state_machine(void);

/* Function Name: usb_interface_init */
/******************************************************************************************************************//**
 * @brief This function initializes the USB interface.
 *********************************************************************************************************************/
fsp_err_t usb_interface_init (void);

/* Function Name: usb_event_process */
/******************************************************************************************************************//**
